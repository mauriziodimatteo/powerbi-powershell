# This is a headless variant of manageRefresh.ps1
# No GUI is shown and authentication takes place through explicit username and password.
...
function GetAuthToken
{
       ...
       $userCred = New-Object �Microsoft.IdentityModel.Clients.ActiveDirectory.UserCredential� -ArgumentList $userName, $password
